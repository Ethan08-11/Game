...
-- ----------------------------
INSERT INTO `bullies` VALUES (1, 'BULLY_BASIC_001', '普通霸凌者', '当前版本唯一的霸凌者模板，后续可扩展为多个难度与行为模板。', 50, 5, 0, 1, 0, '{"targetRule": "both_players", "canCritical": true, "attackPattern": "single_target"}', 1, '2026-07-22 13:04:31', '2026-07-22 13:04:31');
