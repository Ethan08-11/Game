...
-- ----------------------------
INSERT INTO `bullies` VALUES (1, 'BULLY_BASIC_001', '普通霸凌者', '已停用。当前对局所有顾客共用硬扛恶霸。', 110, 5, 0, 1, 0, '{"targetRule": "both_players", "canCritical": true, "attackPattern": "single_target"}', 0, '2026-07-22 13:04:31', '2026-07-22 13:04:31');
INSERT INTO `bullies` VALUES (2, 'BULLY_FOCUS_001', '点名恶霸', '已停用。当前对局所有顾客共用硬扛恶霸。', 180, 22, 0, 1, 0, '{"customerCode":"CUSTOMER_KIND","pattern":"FOCUS_LOW_HP","chance":100,"shield":0,"bonusAttack":0,"catalogSummary":"专打血更虚的护卫；护盾可以挡住。"}', 0, '2026-07-22 13:04:31', '2026-07-22 13:04:31');
INSERT INTO `bullies` VALUES (3, 'BULLY_SHIELD_001', '硬扛恶霸', '所有顾客共用。约一成五回合胸口多 14 点盾，这回合出手也变轻。', 150, 24, 0, 1, 0, '{"customerCode":"*","pattern":"ROUND_SHIELD","chance":15,"shield":14,"bonusAttack":0,"catalogSummary":"约一成五回合胸口多 14 点盾，这回合出手也变轻。"}', 1, '2026-07-22 13:04:31', '2026-07-22 13:04:31');
INSERT INTO `bullies` VALUES (4, 'BULLY_REVENGE_001', '针对恶霸', '已停用。当前对局所有顾客共用硬扛恶霸。', 180, 22, 0, 1, 0, '{"customerCode":"CUSTOMER_ANXIOUS","pattern":"FOCUS_TOP_DAMAGE","chance":85,"shield":0,"bonusAttack":6,"catalogSummary":"约八成五回合会盯打得最疼的人多挨 6 点。"}', 0, '2026-07-22 13:04:31', '2026-07-22 13:04:31');
INSERT INTO `bullies` VALUES (5, 'BULLY_PAIR_001', '不落单恶霸', '已停用。当前对局所有顾客共用硬扛恶霸。', 180, 22, 0, 1, 0, '{"customerCode":"CUSTOMER_WINDOW","pattern":"BOTH_HALF_SWING","chance":0,"shield":0,"bonusAttack":0,"catalogSummary":"两人都几乎挡住时，下一拍会再抽半刀。"}', 0, '2026-07-22 13:04:31', '2026-07-22 13:04:31');
