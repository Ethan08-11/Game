...
INSERT INTO `bullies` VALUES (2, 'BULLY_FOCUS_001', '点名恶霸', '专挑更弱的护卫下手。血量持平时打销售。盾挡完仍会漏 8 点。', 180, 22, 0, 1, 0, '{"customerCode":"CUSTOMER_KIND","pattern":"FOCUS_LOW_HP","chance":100,"shield":0,"bonusAttack":0,"catalogSummary":"专打更弱的护卫；盾挡完仍会漏 8 点。"}', 1, '2026-07-22 13:04:31', '2026-07-22 13:04:31');
