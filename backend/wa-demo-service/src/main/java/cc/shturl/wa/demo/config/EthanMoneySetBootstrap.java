...
/**
 * 将 Ethan 排行榜金币一次性改为 1840。
 */
@Component
@Order(8)
public class EthanMoneySetBootstrap implements ApplicationRunner {

    private static final Logger log = LoggerFactory.getLogger(EthanMoneySetBootstrap.class);
    private static final String PATCH_ID = "set_ethan_money_1840_20260920";
    private static final long TARGET_MONEY = 1840L;

    private final JdbcTemplate jdbcTemplate;
    private final TransactionTemplate transactionTemplate;

    public EthanMoneySetBootstrap(JdbcTemplate jdbcTemplate,
    ...
    private void setEthanMoney() {
        List<Map<String, Object>> rows = jdbcTemplate.queryForList("""
                ...
                """);
        if (rows.isEmpty()) {
            log.warn("Set Ethan money skipped; user not found.");
            return;
        }
        ...
        int updated = jdbcTemplate.update(
                ...
                TARGET_MONEY, userId);
        log.warn("Set Ethan money user={} id={}: {} -> {}, rows={}",
