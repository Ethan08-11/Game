...
import listBg from '@/assets/quest-list-bg.webp'
import dailyTagBg from '@/assets/tag-daily-bg.webp'
import growthTagBg from '@/assets/tag-growth-bg.webp'
import eventTagBg from '@/assets/tag-event-bg.webp'
