      ...
      <div class="rules-body">
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>双方都结束后，霸凌者会同时攻击两名护卫（销售与采购各结算一次），扣除血值；不是只打一人，也不是两人分摊</li>
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>霸凌者初始血值 100～110（每局随机），与玩家一样用血值；将其打到 0 即可救下顾客</li>
            <li>每回合双方出完牌后，霸凌者同时攻击两名护卫，每人受到 10 点伤害（不是只打一人、也不是两人分摊）。本次伤害可被卡牌提高或降低</li>
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>复活后血值在 10～20 点之间随机，且不超过自身上限</li>
            <li>超时未复活或主动放弃，保护失败；双方同时倒下则无法复活</li>
          </ul>
        </section>
        <section class="rule-section">
          <h3>胜利奖励</h3>
          <p>胜利获得 50 金币，失败获得 40 金币。胜利时每位玩家还会随机解锁一张尚未拥有的收藏卡，收入卡牌图鉴；未解锁的卡不会出现在对局中。本部门基础卡每局都会带上；已解锁收藏卡有单独名额，最近没上场的会优先抽到。</p>
        </section>
      </div>
    </div>
  </div>
