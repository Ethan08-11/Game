      ...
      <div class="rules-body">
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>霸凌者初始血值 132～148（每局随机），与玩家一样用血值；将其打到 0 即可救下顾客</li>
            <li>每回合双方出完牌后，霸凌者出手：攻击在 17～20 之间掷一次（期望约 18.5），约八成打满、约两成自己 +12 盾且攻击减半但仍出手。第 2 回合起顾客可能再加减攻击。所有出手盾挡完仍至少漏 3 点（半伤时漏 2 点）。点名恶霸只打更弱的那人，漏伤提到 6 / 3 点；硬扛恶霸的两成回合就是这层 12 点盾；针对恶霸约八成回合给本回合打得最疼的人再加 5 点；不落单恶霸在两人都掉血不超过 2 点时，下回合再对两人追加一次半伤</li>
