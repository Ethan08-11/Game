      ...
      <div class="rules-body">
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>每回合双方出完牌后，霸凌者出手：销售+采购时攻击 20～23，双销售 21～24。约八成五打满、约一成五自己 +14 盾且攻击减半但仍出手。第 2 回合起顾客可能再加减攻击。点名恶霸只打更弱的那人，盾挡完仍会漏 8 点（半伤时漏 4 点）；硬扛恶霸的一成五回合就是这层 14 点盾；针对恶霸约八成五回合给本回合打得最疼的人再加 6 点；不落单恶霸在两人都掉血不超过 2 点时，下回合再对两人追加一次半伤</li>
