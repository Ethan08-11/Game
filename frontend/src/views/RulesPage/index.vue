      ...
      <div class="rules-body">
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>双方都结束后，霸凌者按本局模板出手：点名恶霸只打当前血更低的那人（持平打销售）；其余仍同时打两名护卫</li>
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>霸凌者血量按组队缩放：销售+采购约 168～188，双销售约 210～235（每局随机）。与玩家一样用血值；将其打到 0 即可救下顾客</li>
            <li>每回合双方出完牌后，霸凌者出手：销售+采购时攻击 20～23，双销售 21～24。约八成五打满、约一成五自己 +14 盾且攻击减半但仍出手。第 2 回合起顾客可能再加减攻击。所有出手盾挡完仍至少漏 4 点（半伤时漏 3 点）。点名恶霸只打更弱的那人，漏伤提到 8 / 4 点；硬扛恶霸的一成五回合就是这层 14 点盾；针对恶霸约八成五回合给本回合打得最疼的人再加 6 点；不落单恶霸在两人都掉血不超过 2 点时，下回合再对两人追加一次半伤</li>
