    ...
    <div class="rules-content">
      ...
      <div class="rules-body">
        ...
        <section class="rule-section">
          <h3>基本流程</h3>
          <ul>
            <li>每人牌库尽量凑满 30 张。当前用本部门成员卡：基础每种 2 张 + 本部门收藏各 1 张，再用公共部雇佣兵基础卡补位。中立卡已下架。不含对方部门。解锁不足时可少于 30 张，够了就必须满 30 张</li>
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>销售+采购、双采购时霸凌者血量 200；双销售时 250。与玩家一样用血值；将其打到 0 即可救下顾客</li>
