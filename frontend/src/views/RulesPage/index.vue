    ...
    <div class="rules-content">
      ...
      <div class="rules-body">
        <section class="rule-section">
          <h3>游戏目标</h3>
          <p>两位玩家合作，打出卡牌将霸凌者体力降到 0 即可获胜。任意一名玩家倒下时，若队友仍存活，可尝试复活；双方都倒下、放弃复活或复活超时，则保护失败。</p>
        </section>
        <section class="rule-section">
          <h3>基本流程</h3>
          <ul>
            ...
            <li>双方都结束后，霸凌者会同时攻击两名玩家</li>
            <li>将霸凌者体力打到 0 即胜利</li>
          </ul>
        </section>
        <section class="rule-section">
          <h3>卡牌类型</h3>
          <ul>
            <li><strong>攻击牌</strong>：对霸凌者造成伤害</li>
            <li><strong>防御牌</strong>：为自己或队友增加护盾，抵挡霸凌者伤害</li>
            <li><strong>抽牌牌</strong>：本回合额外抽牌，未打出的牌仍会在结束回合时弃掉</li>
            <li><strong>治疗牌</strong>：恢复自己或队友体力</li>
        ...
        <section class="rule-section">
          <h3>体力与护盾</h3>
          <ul>
            <li>销售部初始体力 50，采购部初始体力 75</li>
            <li>霸凌者初始体力 50，每回合对两名玩家各造成 5 点伤害（可被卡牌增减）</li>
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>复活后体力在 10～20 点之间随机，且不超过自身上限</li>
            <li>超时未复活或主动放弃，对局失败；双方同时倒下则无法复活</li>
          </ul>
        </section>
        <section class="rule-section">
          <h3>胜利奖励</h3>
          <p>胜利获得 50 金币，失败获得 10 金币。胜利时每位玩家还会随机解锁一张尚未拥有的收藏卡，收入卡牌图鉴；未解锁的卡不会出现在对局中。本部门基础卡每局都会带上；已解锁收藏卡有单独名额，最近没上场的会优先抽到。</p>
        </section>
      </div>
    </div>
  </div>
