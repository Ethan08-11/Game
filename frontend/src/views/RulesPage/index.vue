      ...
      <div class="rules-body">
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>霸凌者血量按组队缩放：销售+采购约 196～220，双销售约 210～235（每局随机）。与玩家一样用血值；将其打到 0 即可救下顾客</li>
            <li>每回合双方出完牌后，霸凌者出手：销售+采购时攻击 23～26，双销售 21～24。约八成五打满、约一成五自己 +14 盾且攻击减半但仍出手。第 2 回合起顾客可能再加减攻击。点名恶霸只打更弱的那人，盾挡完仍会漏 10 点（半伤时漏 5 点）；硬扛恶霸的一成五回合就是这层 14 点盾；针对恶霸约八成五回合给本回合打得最疼的人再加 8 点；不落单恶霸在两人都掉血不超过 3 点时，下回合再对两人追加一次半伤</li>
