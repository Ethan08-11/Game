    ...
    <div class="rules-content">
      ...
      <div class="rules-body">
        ...
        <section class="rule-section">
          <h3>基本流程</h3>
          <ul>
            <li>每人牌库尽量凑满 30 张。只用本部门成员卡：基础每种 2 张 + 本部门收藏各 1 张，不够 30 张再用基础卡副本填满。公共部、中立卡已下架。不含对方部门。没有基础卡可复制时可以少于 30 张</li>
            <li>开局双方查看手牌后，由房主决定谁先出牌</li>
            <li>每回合把手牌抽满到 5 张；没打出的牌留到下回合，只补抽缺口</li>
            <li>玩家轮流打出卡牌，消耗调用机会；打出的牌进入弃牌。牌库抽空后再把弃牌洗回</li>
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li><strong>抽牌牌</strong>：本回合额外抽牌，没打出的仍留在手里</li>
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>销售+采购、双采购时霸凌者血量 140；双销售时 250。与玩家一样用血值；将其打到 0 即可救下顾客</li>
            <li>每回合双方出完牌后，硬扛恶霸出手：销售+采购 / 双采购时攻击 17～20，双销售 18～21。约八成五打满、约一成五自己 +14 盾且攻击减半但仍出手。第 2 回合起顾客可能再加减攻击。护盾可以挡住</li>
