      ...
      <div class="rules-body">
        ...
        <section class="rule-section">
          ...
          <ul>
            ...
            <li>每回合双方出完牌后，霸凌者出手：攻击在 12～14 之间掷一次（期望 13），约七成打满、约三成自己 +8 盾且攻击减半但仍出手。第 2 回合起顾客可能再加减攻击。点名恶霸只打更弱的那人，盾挡完仍至少漏 4 点（半伤时漏 2 点）；硬扛恶霸的三成回合就是这层 8 点盾；针对恶霸约七成回合给本回合打得最疼的人再加 5 点；不落单恶霸在两人都掉血不超过 2 点时，下回合再对两人追加一次半伤</li>
